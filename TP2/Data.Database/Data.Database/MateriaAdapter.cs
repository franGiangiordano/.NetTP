    ...
    public class MateriaAdapter : Adapter
    {
        ...
        public List<Materia> GetMateriasAlumno(int idAlumno)
        {
            ...
            try
            {
                ...
                SqlCommand cmdMaterias = new SqlCommand("select * from materias m join cursos c on m.id_materia=c.id_materia join alumnos_inscripciones ai on ai.id_curso=c.id_curso where ai.id_alumno=@idAlumno;", sqlconn);
                cmdMaterias.Parameters.Add("@idAlumno", SqlDbType.Int).Value = idAlumno;
                SqlDataReader drMaterias = cmdMaterias.ExecuteReader();

...
namespace UI.Desktop
{
    public partial class formListaUsuarios : Form
    {
        ...
        public formListaUsuarios()
        {
            ...
            this.dgvUsuarios.DataSource = this.oUsuarios.GetAll(); //agregamos los usuarios al DataGridView
        }
        ...
        private void GenerarColumnas()
        {
            ...
            //Comenté esta linea porque me tira un error de referencia a pesar de que los nombres coinciden

...
namespace Negocio
{
...

    {
        ...
        /*Este método aplicará los cambios en la base de datos con el Update y con el
          AcceptChanges le hará que en la DataTable sepa que los cambios que tenía
          pendientes ya fueron aplicados*/
        ...
        public Usuarios()
        {
            ...
            "Data Source=localhost\\SQLEXPRESS;Initial Catalog=academia;Integrated Security=SSPI;");
            /*
